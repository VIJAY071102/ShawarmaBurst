...
function Details() {
  return (
    <div className="bg-black text-white flex items-center justify-center px-3 sm:px-4 py-8 sm:py-10">
      <div className="max-w-3xl w-full bg-zinc-900 p-5 sm:p-8 md:p-12 rounded-2xl shadow-lg border border-zinc-800">
        
        {/* Title */}
        <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold text-yellow-500 text-center">
          Shawarma Burst
        </h1>

        {/* Subtitle */}
        <h3 className="text-sm sm:text-base md:text-xl text-gray-300 mt-2 sm:mt-3 text-center">
          A Flavor-First Fast Food Experience
        </h3>

        {/* Divider */}
        <div className="w-16 sm:w-20 h-1 bg-yellow-500 mx-auto my-4 sm:my-6 rounded-full"></div>

        {/* Content */}
        <p className="text-gray-300 leading-relaxed text-xs sm:text-sm md:text-base text-justify">
